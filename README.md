    ...
    <style type="text/css">
      <![CDATA[
          @font-face {
            ...
            <div class="container">
                <h3> Perhaps the central problem we face in all of computer science is how we are to get to the situation where we build on top of the work of others rather than redoing so much of it in a trivially different way.</h3>
                <p>- Richard Hamming</p>
            </div>
        </div>
    </foreignObject>
...
<p align="center">
  <img  width="100%" height="180em" src="https://raw.githubusercontent.com/abhisheknaiidu/abhisheknaiidu/master/code.gif"/>
</p>
